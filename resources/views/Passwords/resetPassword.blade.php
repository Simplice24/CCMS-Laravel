            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form action="" method="POST">
                ...
                <div class="form-group first">
                  ...
                  <input type="email" class="form-control" name="email" placeholder="Email address" value="{{ $email ?? old('email')}}">
                </div>
                ...
                <div class="form-group last mb-3">
                  ...
                  <input type="password" class="form-control" name="password" placeholder="Confirm password" id="password">
                </div>
