  ...
  <ul class="dropdown-menu">
    ...
    <div class="d-flex align-items-start">
        ...
        <a href="<?=url('Home');?>"><button class="nav-link" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fa fa-home"></i>&nbsp; Dashboard</button></a>
          <button class="nav-link active" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fa fa-users"></i>&nbsp; System Users</button>
    ...
    <div class="Content">
        <button type="button" class="btn btn-primary" id="modal-btn"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add User</button>
        <div class="modal-bg">  
    <div class="form-card">
        ...
        <table class="table table-hover">
            ...
            <tbody>
              ...
              <td>{{  $i->id }}</td>
                ...
                <td>{{  $i->role }}</td>
                <td>
                <a href={{"viewuser/".$i->id}}><button type="button" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; View</button></a>
                <a href={{"update/".$i->id}}><button type="button" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp; Update</button></a>
