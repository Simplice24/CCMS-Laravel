...
<nav class="navbar navbar-expand-lg bg-light">
  ...
  <div class="card-body">
    <div class="info">
    <p>Cooperative name: {{$information->name}}<p>
    <p>Manager name: {{$information->manager_name}}<p>
    <p>Cooperative category: {{$information->category}}<p>
    ...
    <a href="<?=url('viewcooperatives');?>"><button type="button" class="btn btn-primary">Go back</button></a>
  </div>
      </div>
    </div>
